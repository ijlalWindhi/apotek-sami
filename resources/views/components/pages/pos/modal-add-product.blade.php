...
<script>
    ...
    const templates = {
        ...
        tableRowProduct: (product) => `
            <tr id="list_product_recipe${product.id}" class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                <th scope="row" class="px-3 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    ${utils.escapeHtml(product.name || '-')}
                </th>
                <td class="px-3 py-2 text-gray-500 dark:text-gray-400">
                    <div class="flex justify-center items-center gap-1">
                        ...
                        <input type="number" name="product_recipetotal_${product.id}" id="product_recipetotal_${product.id}"
                    ...
                    <input type="hidden" name="product_recipeid_${product.id}" id="product_recipeid_${product.id}"
                        value="${product.id}">
                </td>
                <td class="px-3 py-2 text-gray-500 dark:text-gray-400">
                    ...
                    <input type="hidden" name="product_recipeconversion_${product.id}" id="product_recipeconversion_${product.id}"
                        value="${product.conversion_value}">
                </td>
                <td class="px-3 py-2 text-gray-500 dark:text-gray-400">
                    <input type="text" name="product_recipeprice_${product.id}" id="product_recipeprice_${product.id}"
                        required readonly
                ...
                <td class="px-3 py-2 text-gray-500 dark:text-gray-400">
                    <input type="text" name="product_recipetuslah_${product.id}" id="product_recipetuslah_${product.id}"
                        required
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full px-2.5 py-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Tuslah" value="0">
                </td>
                <td class="px-3 py-2 text-gray-500 dark:text-gray-400">
                    <input type="text" name="product_recipediscount_${product.id}" id="product_recipediscount_${product.id}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full px-2.5 py-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Diskon" value="0">
                </td>
                <td class="px-3 py-2 text-gray-500 dark:text-gray-400">
                    <input type="text" name="product_recipesubtotal_${product.id}" id="product_recipesubtotal_${product.id}" required
                        class="bg-gray-200 border border-gray-300 text-gray-900 text-xs rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full px-2.5 py-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
