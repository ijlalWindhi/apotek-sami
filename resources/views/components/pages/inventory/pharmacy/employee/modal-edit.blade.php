<div id="modal-edit-employee" tabindex="-1" aria-hidden="true"
...
<script>
    ...
    $('#modal-edit-employee form').on('submit', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(response) {
                // Close modal
                $('#modal-edit-employee').removeClass('flex').addClass('hidden');
                Swal.fire({
                    icon: "success",
