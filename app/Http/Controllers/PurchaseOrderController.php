...
class PurchaseOrderController extends Controller
{
    ...
    {
        return view('pages.inventory.transaction.purchase-order', [
    ...
    {
        return view('pages.inventory.trasaction.purchase-order.create', [
    ...
    {
        return view('pages.inventory.trasaction.purchase-order.edit', [
